  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      <div className='mb-8'>
        ...
        <p className='text-muted-foreground'>Sigue rutas de aprendizaje personalizadas diseñadas para tu progreso educativo</p>
      </div>
                ...
                <CardHeader>
                  <div className='flex items-start justify-between gap-4'>
                    <div className='flex-1 min-w-0'>
                      ...
                      <CardDescription className='line-clamp-2'>{progress.learningPath?.description}</CardDescription>
                    </div>
