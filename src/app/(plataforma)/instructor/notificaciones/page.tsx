    ...
    <>
      <header className='border-b border-border flex items-center justify-between p-4'>
        <div>
          ...
          <p className='text-sm text-muted-foreground'>Mantente al día con las actualizaciones</p>
        </div>
          ...
          <ScrollArea className='h-[calc(100vh-12rem)]'>
            <div className='space-y-2'>
              {notifications.length === 0 ? (
                <div className='text-center text-muted-foreground py-8'>No hay notificaciones</div>
              ) : (
                    ...
                    <div className='flex items-start justify-between gap-4'>
                      <div className='flex-1'>
                        <div className='flex items-center gap-2 mb-1'>
                          ...
                          {!notification.isRead && <Badge variant='default'>Nuevo</Badge>}
                        </div>
