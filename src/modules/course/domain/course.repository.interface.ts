...
export interface ICourseRepository extends Repository<Course> {
   ...
   */
  findMany(options?: CourseListOptions): Promise<Result<CourseListResult>>

  /**
   * Find courses by instructor
   */
  findByInstructor(instructorId: string, options?: CourseListOptions): Promise<Result<CourseListResult>>
   ...
   */
  findPublished(options?: CourseListOptions): Promise<Result<CourseListResult>>
