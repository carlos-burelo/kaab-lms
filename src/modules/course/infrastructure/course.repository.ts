...
export class CourseRepository implements ICourseRepository {
  ...
  async findById(id: string): Promise<Result<Course | null>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to find course by id', error as Error)
      );
    }
  }
  ...
  async findBySlug(slug: string): Promise<Result<Course | null>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to find course by slug', error as Error)
      );
    }
  }
  ...
  async save(entity: Course): Promise<Result<Course>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to save course', error as Error)
      );
    }
  }
  ...
  async delete(id: string): Promise<Result<void>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to delete course', error as Error)
      );
    }
  }
  ...
  async exists(id: string): Promise<Result<boolean>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to check course existence', error as Error)
      );
    }
  }
  ...
  async slugExists(slug: string): Promise<Result<boolean>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to check slug existence', error as Error)
      );
    }
  }
  ...
  async findMany(
    ...
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to find courses', error as Error)
      );
    }
  }
  ...
  async findFeatured(limit: number = 10): Promise<Result<Course[]>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to find featured courses', error as Error)
      );
    }
  }
  ...
  async countByInstructor(instructorId: string): Promise<Result<number>> {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to count instructor courses', error as Error)
      );
    }
  }
  ...
  > {
    try {
      ...
      return Result.fail(
        new DatabaseError('Failed to get course statistics', error as Error)
      );
    }
  }
