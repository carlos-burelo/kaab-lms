...
import { z } from 'zod'
import { MissionDifficulty, MissionDifficultyValues, MissionType, MissionTypeValues } from '../../domain/value-objects'
...
export const CreateMissionSchema = z
  .object({
    ...
    difficulty: z.enum(MissionDifficultyValues as [string, ...string[]]).default(MissionDifficulty.NORMAL),
