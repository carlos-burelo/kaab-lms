...
> {
  ...
  async execute(
    ...
    if (dto.description) {
      const updateDescriptionResult = achievement.updateDescription(
        dto.description
      );
    ...
    if (dto.coinReward !== undefined) {
      const updateCoinRewardResult = achievement.updateCoinReward(
        dto.coinReward
      );
    ...
    if (dto.maxProgress !== undefined) {
      const updateMaxProgressResult = achievement.updateMaxProgress(
        dto.maxProgress
      );
