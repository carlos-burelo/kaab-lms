...
export class UpdateMissionUseCase extends BaseUseCase<UpdateMissionRequest, MissionDTO> {
  ...
  async execute(request: UpdateMissionRequest): Promise<Result<MissionDTO>> {
    ...
    if (dto.description) {
      const updateDescriptionResult = mission.updateDescription(dto.description)
    ...
    if (dto.startDate !== undefined || dto.endDate !== undefined) {
      const updateDatesResult = mission.updateDates(dto.startDate, dto.endDate)
