...
export interface IAchievementRepository extends Repository<Achievement> {
   ...
   */
  userHasAchievement(userId: string, achievementId: string): Promise<Result<boolean>>

  /**
   * Update user achievement progress
   */
  updateUserAchievementProgress(userId: string, achievementId: string, progress: number): Promise<Result<void>>

  /**
   * Unlock achievement for user
   */
  unlockAchievementForUser(userId: string, achievementId: string): Promise<Result<void>>
}
