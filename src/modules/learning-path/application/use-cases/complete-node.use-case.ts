...
export class CompleteNodeUseCase extends BaseUseCase<CompleteNodeRequest, UserLearningPathProgressDTO> {
  constructor(private learningPathRepository: ILearningPathRepository) {
    super()
  }

  async execute(request: CompleteNodeRequest): Promise<Result<UserLearningPathProgressDTO>> {
