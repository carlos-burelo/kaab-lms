...
import type { UpdateLearningPathDTO } from '../dtos'
...
export class UpdateLearningPathUseCase extends BaseUseCase<UpdateLearningPathRequest, LearningPathDTO> {
  constructor(private learningPathRepository: ILearningPathRepository) {
    super()
  }

  async execute(request: UpdateLearningPathRequest): Promise<Result<LearningPathDTO>> {
