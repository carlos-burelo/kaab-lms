...
export interface ILearningPathRepository extends Repository<LearningPath> {
   ...
   */
  getUserProgress(userId: string, learningPathId: string): Promise<Result<UserLearningPathProgress | null>>

  /**
   * Save user progress
   */
  saveUserProgress(progress: UserLearningPathProgress): Promise<Result<UserLearningPathProgress>>

  /**
   * Check if user has started a learning path
   */
  hasUserStarted(userId: string, learningPathId: string): Promise<Result<boolean>>
   ...
   */
  getStats(learningPathId: string): Promise<
    Result<{
      totalUsers: number
